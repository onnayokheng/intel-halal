...
function QRCode({ data }: { data: string }) {
  const url = `https://api.qrserver.com/v1/create-qr-code/?size=220x220&qzone=2&data=${encodeURIComponent(data)}`;
  return (
    <div style={{
      ...
      <img src={url} alt="QRIS" width={220} height={220} style={{ display: "block" }} />
    </div>
  );
}
