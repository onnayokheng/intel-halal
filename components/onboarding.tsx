    ...
    <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ padding: "0 24px", display: "flex", flexDirection: "column", gap: 14 }}>
        <AuthButton
          ...
          icon={
            <div style={{
              ...
              display: "flex", alignItems: "center", justifyContent: "center",
              fontFamily: "var(--font-fraunces)", fontSize: 13, fontWeight: 600, fontStyle: "italic", color: C.text,
            }}>G</div>
          }
        >
        ...
        <AuthButton
          ...
          icon={
            <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
              <path d="M11 3.5c-4.4 0-8 3.1-8 7 0 1.6.6 3 1.6 4.2L3.5 18.5l4-1.2c1 .5 2.2.7 3.5.7 4.4 0 8-3.1 8-7s-3.6-7-8-7z" stroke="#fff" strokeWidth="1.6" strokeLinejoin="round"/>
              <path d="M8 11.5c.6 1.5 2 2.4 3.5 2.4M8.5 8.8c.2.3.6.5 1 .4M13.5 9.2c-.2.3-.6.4-1 .3" stroke="#fff" strokeWidth="1.6" strokeLinecap="round"/>
            </svg>
          }
        >
